...
class NoRoomNameGrab(forms.Form):
    username=forms.CharField(required=True, label=False, widget=forms.TextInput(attrs={'class' : 'form-control', 'type' : 'name', 'id' : "inputName", 'placeholder' : "Name" }))
