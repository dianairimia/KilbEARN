...
var hause = new Image();
hause.src = "/static/images/normalHause.png";
var hotel = new Image();
hotel.src = "/static/images/fancyHause.png";
...
function init() {
 ...
 player[0].src = "/static/images/squaredpython.png";

 player[1].src = "/static/images/jssquared.png";

 player[2].src = "/static/images/swiftsquared.png";

 player[3].src = "/static/images/rubysquared.png";
...
// var player1_name = data[0].name;
// var player1_icon = data[0].icon;
// var player1_money = data[0].money;
// td1.innerHTML = player1_name;
// td2.innerHTML = player1_icon;
// td3.innerHTML = player1_money;
// row.appendChild(td1);
// row.appendChild(td2);
// row.appendChild(td3);
// table.children[0].appendChild(row);
//
// // var player2_icon = data[0].icon;
// // var player2_money = data[0].money;
// // var player3_name = data[0].name;
// // var player3_icon = data[0].icon;
// // var player3_money = data[0].money;
// // var player4_name = data[0].name;
// // var player4_icon = data[0].icon;
// // var player4_money = data[0].money;
